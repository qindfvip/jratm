...
import com.base.common.utils.file.FileUtil;
import com.base.common.utils.file.ImageUtil;
import com.base.common.utils.util.ExceptionUtil;
...
public class CrudController extends Controller {
	...
	public void toAdd() {
		...
		render("/"+PATH+"/template/crud/add.html");
	}
	...
	public void toUpdate() {
		...
		render("/"+PATH+"/template/crud/update.html");
	}
	...
	public void toImportXls() {
		...
		render("/"+PATH+"/template/crud/dialog/import.html");
	}
	...
	public void list() {
		...
		render("/"+PATH+"/template/crud/list.html");
	}
	...
	public void add() {
		...
		// 记录新增日志
		SystemLog.dao.info(this, SystemLog.ADD, eo.getStr("code"));
	...
	public void delete() {
		...
		// 记录新增日志
		SystemLog.dao.info(this, SystemLog.DELETE, eo.getStr("code") + "[" + pkValues + "]");
	...
	public void update() {
		...
		// 记录新增日志
		SystemLog.dao.info(this, SystemLog.UPDATE, eo.getStr("code") + "[" + pkValue + "]");
	...
	public void importXls() {
		...
		// 记录导入日志
		SystemLog.dao.info(this, SystemLog.IMPORT, eo.getStr("code"));
	...
	public void uploadImg() {
		...
		try {
			// 上传到/upimg 目录
			file = getFile(name, AppConst.DIR_IMG);
			if (xx.isEmpty(file)) {
